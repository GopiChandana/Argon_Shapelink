    ...
    for(var j=0;j<mm_1.length;j++)
    {
        var tabval=document.getElementById("cardiolist_table")
            var out=`<tr id="${mm_1[j][0]}" >
                  ...
                  <td width="18%"><b id="amt_cal">${mm_1[j][2]}</b></td>
                  <td width="15%"><b id="amt_pro">${mm_1[j][3]}</b></td>
                  <td width="15%"><b id="amt_fat">${mm_1[j][4]}</b></td>
                  <td width="20%"><b id="amt_carbo">${mm_1[j][5]}</b></td>
